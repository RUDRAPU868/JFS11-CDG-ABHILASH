...
public class EmployeeDaoImpl implements EmployeeDao {
  	...
  	public String add(Employee employee) {
        	...
        	try {
              	...
              	if (emp == null) {
                    	...
                    	PreparedStatement preparedStatement = connection.prepareStatement("insert into emp10 values(?,?,?,?)");
  	...
  	public Employee search(int eno) {
        	...
        	try {
              	...
              	ResultSet resultSet = statement.executeQuery("select * from emp10 where ENO = " + eno);
